...
class CInstrumentSettingsVRC6;

// CSequenceEditorVRC6

class CSequenceEditorVRC6 : public CWnd
{
	DECLARE_DYNAMIC(CSequenceEditorVRC6)

public:
	CSequenceEditorVRC6();
	virtual ~CSequenceEditorVRC6();
	...
	void SetParent(CInstrumentSettingsVRC6 *pParent);
...
protected:
	CInstrumentSettingsVRC6	*m_pParent;
	DECLARE_MESSAGE_MAP()
public:
